        ...
        <div className="bg-gradient-to-r from-adking-primary to-adking-secondary text-adking-dark py-16 md:py-24 px-4 shadow-inner relative">
          <div className="container mx-auto text-center max-w-3xl relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button size="lg" onClick={handleGetStarted} className="text-base md:text-lg px-6 py-4 md:px-8 md:py-5 h-auto w-full sm:w-auto shadow-lg text-slate-50 rounded-xl bg-adking-dark">
