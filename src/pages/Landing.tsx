      ...
      <main className="pt-20 md:pt-32">
        ...
        <div ref={heroRef} className="container mx-auto text-center max-w-4xl mb-12 md:mb-20 px-4 animate-on-scroll">
          ...
          <div className="mt-12 md:mt-20 mb-12 md:mb-20 relative mx-auto max-w-5xl px-4">
            <div className="<div class=\"flex items-center justify-center min-h-screen\">\n  <div class=\"aspect-video relative rounded-2xl overflow-hidden bg-metamaster-gray-800/50 border border-white/10 flex flex-col items-center justify-center transform-none rotate-0\">\n    <!-- video or placeholder here -->\n  </div>\n</div>">
