        ...
        <div className="container mx-auto px-4 pb-12">
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-8 mb-8">
            <div className="flex items-center mb-6">
              <div className="bg-metamaster-primary/10 w-12 h-12 rounded-lg flex items-center justify-center text-metamaster-primary mr-4 bg-amber-50">
                <Image size={24} />
              </div>
              <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="bg-metamaster-primary hover:bg-metamaster-secondary w-full md:w-auto" disabled={isSubmitting}>
